var init = function (window) {
    ...
    var background = opspark.makeBackground(app,ground);//calls makeBackground function and stores it to variable background
    ...
    var hud = opspark.makeHud(); //calls makeHud function and stores it to variable hud
    view.addChild(hud); // uses the addChild function call to add the hud as the child of view so it is visible on screen 
    window.hud = hud; //assigns the varible to window.hud
